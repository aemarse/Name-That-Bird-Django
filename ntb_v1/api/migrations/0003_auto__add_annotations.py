...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'api_annotations', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('sound', self.gf('django.db.models.fields.related.ForeignKey')(related_name='annotations', to=orm['api.Sounds'])),
        ...
        db.send_create_signal(u'api', ['Annotations'])


    def backwards(self, orm):
        # Deleting model 'Annotations'
        db.delete_table(u'api_annotations')
