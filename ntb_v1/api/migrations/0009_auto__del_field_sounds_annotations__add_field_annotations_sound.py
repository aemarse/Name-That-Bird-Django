...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Deleting field 'Sounds.annotations'
        db.delete_column(u'api_sounds', 'annotations_id')

        # Adding field 'Annotations.sound'
        db.add_column(u'api_annotations', 'sound',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, related_name='annotations', to=orm['api.Sounds']),
                      keep_default=False)


    def backwards(self, orm):
        # Adding field 'Sounds.annotations'
        db.add_column(u'api_sounds', 'annotations',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['api.Annotations']),
                      keep_default=False)
