...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'api_sounds', 'annotations',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=0, to=orm['api.Annotations']),
                      keep_default=False)
    ...
    models = {
        ...
        u'api.sounds': {
            ...
            'added_date': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'annotations': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['api.Annotations']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
